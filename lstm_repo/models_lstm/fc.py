...
class FC(nn.Module):
    ...
    hidden_sizes : List[int]
        ...
        The number of layers in the FC (Fully Connected) class is implicitly defined by the length of the hidden_sizes: 
        List[int] parameter provided when initializing the class
