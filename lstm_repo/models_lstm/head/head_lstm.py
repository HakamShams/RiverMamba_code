...
def get_head(head_type: str, n_in: int, n_out: int, output_activation: str = None) -> nn.Module:
    ...
    output_activation : str, optional
        The activation function to be used in the output layer for regression heads.
