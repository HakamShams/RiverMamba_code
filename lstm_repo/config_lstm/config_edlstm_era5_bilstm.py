...
def add_all_arguments(parser):
    ...
    # --- general options --- #
    parser.add_argument('--name', type=str, default='edbilstm_obsmap_era5tar_weight_14', help='name of the experiment')
    ...
    parser.add_argument('--hindcast_hidden_size', type=int, default=256, help='hidden dimension for the bidirectional hindcastLSTM')
    ...
    parser.add_argument('--seed', type=int, default=89, help='random seed')
