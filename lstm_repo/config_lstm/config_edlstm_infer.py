...
def add_all_arguments(parser):
    ...
    # --- general options --- #
    parser.add_argument('--name', type=str, default='edlstm_obsmap_era5tar_14_obstar_v2_new', help='name of the experiment')
    ...
    parser.add_argument('--years_train', type=str, default=[str(year) for year in range(1983, 2017)], help='years for training')
    parser.add_argument('--years_val', type=str, default=['2017','2018','2019','2020'], help='years for validation')
    ...
    parser.add_argument('--is_target_obs', type=bool, default=False, help='use GRDC obs as target for loss and eval or not')
    ...
    parser.add_argument('--n_target_points', type=int, default=3366, help='fixed num for total stations') # number of grid points selecting from one map
