...
def add_all_arguments(parser):
    ...
    # --- general options --- #
    parser.add_argument('--name', type=str, default='edlstm_obsmap_era5tar_14_obstar', help='name of the experiment')
    parser.add_argument('--dir_log', type=str, default=r'./RiverMamba_code/lstm_repo/log', help='log folder')
    parser.add_argument('--pretrained_model_path', type=str, default=r'./RiverMamba_code/lstm_repo/log/edlstm_obsmap_era5tar_14/model_checkpoints/best_loss_model.pth', help='pretrained_model_path from era5 reanalysis')
    # finetune and resume can only be one True and one False
    parser.add_argument('--finetune', type=bool, default=False, help='fine tune on obs or not')
    parser.add_argument('--resume', type=bool, default=True, help='Resume training from latest checkpoint')
    parser.add_argument('--dir_model', type=str, default=r'./RiverMamba_code/lstm_repo/log/edlstm_obsmap_era5tar_14_obstar/model_checkpoints/', help='Directory to load model checkpoints and resume training (the model run itself)')
    ...
    parser.add_argument('--static_embedding_spec', type=Dict, default={'type': 'fc','hiddens': [30, 20, 64], 'activation': 'tanh', 'dropout': 0}, help='parameter for static var embedding')
    parser.add_argument('--dynamic_embedding_spec', type=Dict, default={'type': 'fc','hiddens': [30, 20, 64], 'activation': 'tanh', 'dropout': 0}, help='parameter for dynamic var embedding')
    ...
    # --- ed_lstm ---
    parser.add_argument('--hindcast_hidden_size', type=int, default=256, help='hidden dimension for the hindcastLSTM')
    parser.add_argument('--forecast_hidden_size', type=int, default=256, help='hidden dimension for the forecastLSTM')
    parser.add_argument('--state_handoff_network_para', type=Dict, default={'hiddens': [512, 256], 'activation': 'tanh', 'dropout': 0.1}, help='parameter for state_handoff_network layer')
