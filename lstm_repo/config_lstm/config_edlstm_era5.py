...
def add_all_arguments(parser):
    ...
    # --- general options --- #
    parser.add_argument('--name', type=str, default='edlstm_obsmap_era5tar_14', help='name of the experiment')
    ...
    parser.add_argument('--dir_model', type=str, default=r'./RiverMamba_code/lstm_repo/log/edlstm_obsmap_era5tar_14/model_checkpoints/', help='Directory to load model checkpoints and resume training (the model run itself)')
    ...
    # --- ed_lstm with separate hidden/cell state ---
    ...
    parser.add_argument('--_preload', type=bool, default=False, help='_preload data or not')
