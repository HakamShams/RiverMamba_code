...
def add_all_arguments(parser):
    ...
    # --- general options --- #
    parser.add_argument('--name', type=str, default='edbilstm_obsmap_era5tar_obstar_weight_14_v1_new', help='name of the experiment')
    ...
    parser.add_argument('--forecast_network_para', type=Dict, default={'hiddens': [128], 'activation': 'relu', 'dropout': 0.1}, help='parameter for FC forecast layer')
