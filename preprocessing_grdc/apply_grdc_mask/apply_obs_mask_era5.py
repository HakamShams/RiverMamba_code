...
base_dir = "./RiverMamba_dataset/ERA5-Land_Reanalysis_Global"
output_base_dir = "./RiverMamba_dataset/GRDC_masked_dataset/ERA5-Land_Reanalysis_Global"
...
for date in dates:
    ...
    if os.path.exists(file_path):
        ...
        data_variables = list(era5.data_vars)
        ...
        for var in data_variables:
            print (var)
            test = era5[var].values[mask_new == 1]
